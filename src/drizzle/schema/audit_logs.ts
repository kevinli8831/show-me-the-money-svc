...
export const auditLogs = pgTable('audit_logs', {
  ...
  entityType: varchar('entity_type', { length: 50 }).notNull(), // e.g., 'ACTIVITIES', 'EXPENSE'
  entityId: bigint('entity_id', { mode: 'number' }).notNull(), // e.g., activityId or expenseId
  activityId: bigint('activity_id', { mode: 'number' }), // Optional: for easier querying by activity
